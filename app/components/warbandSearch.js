        ...
        <div className="mt-4 max-w-2xl">
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-row gap-2">
                <div className="indicator">
                    ...
                    />
                    {errors.lookupCode && (
                        <span className="indicator-item indicator-center indicator-bottom badge badge-error rounded-lg">{errors.lookupCode.message}</span>
                    )}
                </div>
                <button
                    type="submit"
                ...
                >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 aspect-square fill-primary-content">
