...
export default function ChaosButton({ message }) {
    ...
    return (
        ...
        >
            {loading ?
                <>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="h-4 w-4 fill-primary-content" aria-hidden="true">
                ...
                :
                <>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="h-6 w-6 fill-primary-content" aria-hidden="true">
