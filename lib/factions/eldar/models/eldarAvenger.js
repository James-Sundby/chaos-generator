...
export default function EldarAvenger({ primary, secondary, accent, pattern }) {
    ...
    // tuned for the current root viewBox="0 0 716 1868"
    const primaryGradientTransform = "matrix(315,0,0,760,358,470)";
    const secondaryGradientTransform = "matrix(285,0,0,700,358,500)";
    ...
    const accentFill = accent?.hex ?? accent;

    let rightChestArmour, rightChestUndersuit, leftChestArmour, leftChestUndersuit;
    let rightAbs, leftAbs, rightLegArmour, leftLegArmour, rightLegUndersuit, leftLegUndersuit;
    let rightCod, leftCod, rightArmUndersuit, leftArmUndersuit, rightArmArmour, leftArmArmour;
    let rightShoulder, leftShoulder, rightBackVent, leftBackVent, camera;
    let rightHelmet, leftHelmet, rightFacePlate, leftFacePlate;

    const metal = "#3E494A";
    const accessories = accentFill;

    const patternKey = String(pattern ?? "");

    switch (patternKey) {
        case "1":
            rightChestArmour = rightChestUndersuit = leftChestArmour = leftChestUndersuit =
                rightAbs = leftAbs = rightLegArmour = leftLegArmour =
                rightLegUndersuit = leftLegUndersuit = rightCod = leftCod =
                leftArmUndersuit = leftArmArmour = rightShoulder = leftShoulder =
                rightBackVent = leftBackVent = camera = rightFacePlate = leftFacePlate = primaryFill;

            rightHelmet = leftHelmet = rightArmUndersuit = rightArmArmour = secondaryFill;
            break;
        ...
        case "2":
            rightChestArmour = rightChestUndersuit = leftChestArmour = leftChestUndersuit =
                rightAbs = leftAbs = rightLegArmour = leftLegArmour =
                rightLegUndersuit = leftLegUndersuit = rightCod = leftCod =
                rightArmUndersuit = leftArmUndersuit = rightArmArmour = leftArmArmour =
                rightShoulder = leftShoulder = rightBackVent = leftBackVent =
                camera = primaryFill;

            rightHelmet = leftHelmet = rightFacePlate = leftFacePlate = secondaryFill;
            break;

        case "3":
            rightChestUndersuit = leftChestUndersuit = rightAbs = leftAbs =
                rightLegUndersuit = leftLegUndersuit = rightArmUndersuit = leftArmUndersuit =
                rightBackVent = leftBackVent = camera = primaryFill;

            rightChestArmour = leftChestArmour = rightLegArmour = leftLegArmour =
                rightCod = leftCod = rightArmArmour = leftArmArmour =
                rightShoulder = leftShoulder = rightHelmet = leftHelmet = secondaryFill;

            rightFacePlate = leftFacePlate = accentFill;
            break;
        ...
        case "4":
            ...
            rightHelmet = leftHelmet = rightShoulder = leftShoulder = secondaryFill;
            break;

        case "5":
            leftChestArmour = leftChestUndersuit = leftAbs = rightLegArmour =
                rightLegUndersuit = rightCod = leftArmUndersuit = leftArmArmour =
                leftShoulder = leftBackVent = leftHelmet = leftFacePlate = primaryFill;

            rightChestArmour = rightChestUndersuit = rightAbs = leftLegArmour =
                leftLegUndersuit = leftCod = rightArmUndersuit = rightArmArmour =
                rightShoulder = rightBackVent = camera = rightHelmet = rightFacePlate = secondaryFill;
            break;
        ...
        case "6":
            rightChestArmour = rightChestUndersuit = leftChestArmour = leftChestUndersuit =
                ...
                rightArmUndersuit = leftArmUndersuit = rightArmArmour = leftArmArmour =
                rightShoulder = leftShoulder = rightBackVent = leftBackVent =
                camera = rightHelmet = leftHelmet = primaryFill;

            rightFacePlate = leftFacePlate = secondaryFill;
            break;
        ...
        case "7":
            rightChestArmour = rightChestUndersuit = leftChestArmour = leftChestUndersuit =
                ...
                rightArmUndersuit = leftArmUndersuit = rightArmArmour = leftArmArmour =
                rightShoulder = leftShoulder = rightBackVent = leftBackVent =
                camera = rightFacePlate = leftFacePlate = primaryFill;

            rightHelmet = leftHelmet = secondaryFill;
            break;

        case "8":
            leftChestArmour = leftChestUndersuit = leftAbs = leftLegArmour =
                leftLegUndersuit = leftCod = leftArmUndersuit = leftArmArmour =
                leftShoulder = leftBackVent = leftHelmet = leftFacePlate = primaryFill;

            rightChestArmour = rightChestUndersuit = rightAbs = rightLegArmour =
                rightLegUndersuit = rightCod = rightArmUndersuit = rightArmArmour =
                rightShoulder = rightBackVent = camera = rightHelmet = rightFacePlate = secondaryFill;
            break;

        case "9":
            rightChestArmour = rightChestUndersuit = leftChestArmour = leftChestUndersuit =
                rightAbs = leftAbs = rightCod = leftCod =
                rightArmUndersuit = leftArmUndersuit = rightArmArmour = leftArmArmour =
                rightShoulder = leftShoulder = rightBackVent = leftBackVent =
                camera = rightHelmet = leftHelmet = primaryFill;

            rightFacePlate = leftFacePlate = rightLegArmour = leftLegArmour =
                rightLegUndersuit = leftLegUndersuit = secondaryFill;
            break;
        ...
        case "10":
            ...
            rightFacePlate = leftFacePlate = rightLegArmour = leftLegArmour =
                rightLegUndersuit = leftLegUndersuit =
                rightArmUndersuit = leftArmUndersuit = rightArmArmour = leftArmArmour = secondaryFill;
            break;
        ...
        case "11":
            rightChestArmour = rightChestUndersuit = leftChestArmour = leftChestUndersuit =
                rightAbs = leftAbs = rightLegArmour = leftLegArmour =
                rightLegUndersuit = leftLegUndersuit = rightCod = leftCod =
                rightHelmet = leftHelmet = rightFacePlate = leftFacePlate = primaryFill;

            rightArmUndersuit = leftArmUndersuit = rightArmArmour = leftArmArmour =
                rightShoulder = leftShoulder = rightBackVent = leftBackVent = camera = secondaryFill;
            break;
        ...
        default:
            rightChestArmour = rightChestUndersuit = leftChestArmour = leftChestUndersuit =
                ...
                rightArmUndersuit = leftArmUndersuit = rightArmArmour = leftArmArmour =
                rightShoulder = leftShoulder = rightBackVent = leftBackVent =
                camera = rightHelmet = leftHelmet = rightFacePlate = leftFacePlate = primaryFill;
    }
    ...
    return (
        ...
        >
            ...
            {/* existing SVG groups unchanged below */}
