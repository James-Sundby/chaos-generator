...
export default function SpaceMarine({ primary, secondary, trim, pattern }) {
    let leftHelmet, rightHelmet, leftBackpack, rightBackpack, leftChest, rightChest, leftShoulder, rightShoulder, leftShoulderTrim, rightShoulderTrim, leftArm, rightArm, leftHand, rightHand, leftThigh, rightThigh, leftShin, rightShin, leftBoot, rightBoot, codLeft, codRight, leftBelt, rightBelt, eagle, leftArmTrim, rightArmTrim, leftLegTrim, rightLegTrim;

    const primaryGradientId = `primary-metal`;
    const secondaryGradientId = `secondary-metal`;
    const trimGradientId = `trim-metal`;

    const primaryGradientTransform = "matrix(190,0,0,330,150,120)";
    const secondaryGradientTransform = "matrix(175,0,0,300,150,120)";
    const trimGradientTransform = "matrix(160,0,0,280,150,110)";
    ...
    switch (patternKey) {
        case "accipiters":
            leftHelmet = rightHelmet = leftShoulder = rightShoulder = leftShoulderTrim = rightShoulderTrim = leftArm = rightArm = leftHand = rightHand = leftArmTrim = rightArmTrim = primaryFill;
            leftBackpack = rightBackpack = leftChest = rightChest = leftLegTrim = rightLegTrim = leftBelt = rightBelt = codLeft = codRight = leftThigh = rightThigh = leftShin = rightShin = leftBoot = rightBoot = secondaryFill;
            eagle = trimFill;
            break;

        case "arms":
            leftShoulder = rightShoulder = leftShoulderTrim = rightShoulderTrim = leftBackpack = rightBackpack = leftChest = rightChest = leftLegTrim = rightLegTrim = codLeft = codRight = leftThigh = rightThigh = leftShin = rightShin = leftBoot = rightBoot = primaryFill;
            leftHand = rightHand = leftArm = rightArm = leftArmTrim = rightArmTrim = secondaryFill;
            leftHelmet = rightHelmet = eagle = leftBelt = rightBelt = trimFill;
            break;

        case "blazoned":
            leftBackpack = rightBackpack = leftChest = rightChest = leftShoulderTrim = rightShoulderTrim = codLeft = codRight = leftBelt = rightBelt = primaryFill;
            leftHelmet = rightHelmet = leftShoulder = rightShoulder = leftArm = rightArm = leftHand = rightHand = leftArmTrim = rightArmTrim = leftThigh = rightThigh = leftShin = rightShin = leftBoot = rightBoot = leftLegTrim = rightLegTrim = secondaryFill;
            eagle = trimFill;
            break;

        case "centered":
            leftBackpack = rightBackpack = leftShoulder = rightShoulder = leftShoulderTrim = rightShoulderTrim = leftArm = rightArm = leftHand = rightHand = leftThigh = rightThigh = leftShin = rightShin = leftBoot = rightBoot = primaryFill;
            leftHelmet = rightHelmet = leftChest = rightChest = codLeft = codRight = leftBelt = rightBelt = secondaryFill;
            eagle = leftArmTrim = rightArmTrim = leftLegTrim = rightLegTrim = trimFill;
            break;

        case "crusader":
            leftBackpack = rightBackpack = leftChest = rightChest = leftShoulderTrim = rightShoulderTrim = leftArm = rightArm = leftHand = rightHand = leftThigh = rightThigh = leftShin = rightShin = leftBoot = rightBoot = codLeft = codRight = primaryFill;
            leftHelmet = rightHelmet = leftShoulder = rightShoulder = secondaryFill;
            eagle = leftBelt = rightBelt = leftArmTrim = rightArmTrim = leftLegTrim = rightLegTrim = trimFill;
            break;

        case "disciple":
            leftBackpack = rightBackpack = leftShoulderTrim = rightShoulderTrim = leftArm = rightArm = leftHand = rightHand = leftThigh = rightThigh = leftBoot = rightBoot = codLeft = codRight = leftArmTrim = rightArmTrim = leftLegTrim = rightLegTrim = primaryFill;
            leftHelmet = rightHelmet = leftChest = rightChest = leftShin = rightShin = leftShoulder = rightShoulder = secondaryFill;
            leftBelt = rightBelt = eagle = trimFill;
            break;

        case "eradicant":
            leftBackpack = rightBackpack = leftShoulder = rightShoulder = leftShoulderTrim = rightShoulderTrim = leftArm = rightArm = leftHand = rightHand = leftArmTrim = rightArmTrim = primaryFill;
            leftHelmet = rightHelmet = leftChest = rightChest = codLeft = codRight = leftBelt = rightBelt = leftThigh = rightThigh = leftShin = rightShin = leftBoot = rightBoot = leftLegTrim = rightLegTrim = secondaryFill;
            eagle = trimFill;
            break;

        case "half":
            leftHelmet = leftBackpack = leftChest = leftShoulder = leftShoulderTrim = leftArm = leftHand = leftThigh = leftShin = leftBoot = codLeft = leftArmTrim = leftLegTrim = primaryFill;
            rightHelmet = rightBackpack = rightChest = rightShoulderTrim = rightArm = rightHand = rightThigh = rightBoot = codRight = rightShin = rightArmTrim = rightShoulder = rightLegTrim = secondaryFill;
            leftBelt = rightBelt = eagle = trimFill;
            break;

        case "legs":
            leftHelmet = rightHelmet = leftBackpack = rightBackpack = leftChest = rightChest = leftShoulder = rightShoulder = leftShoulderTrim = rightShoulderTrim = leftArm = rightArm = leftHand = rightHand = codLeft = codRight = leftBelt = rightBelt = leftArmTrim = rightArmTrim = primaryFill;
            leftThigh = rightThigh = leftShin = rightShin = leftBoot = rightBoot = leftLegTrim = rightLegTrim = secondaryFill;
            eagle = trimFill;
            break;

        case "quarter":
            leftHelmet = leftBackpack = leftChest = leftShoulder = leftShoulderTrim = leftArm = leftHand = rightThigh = rightShin = rightBoot = codRight = leftBelt = leftArmTrim = rightLegTrim = primaryFill;
            rightHelmet = rightChest = rightShoulder = rightShoulderTrim = rightArm = rightBackpack = leftBoot = rightBelt = rightArmTrim = codLeft = leftLegTrim = rightHand = leftThigh = leftShin = secondaryFill;
            eagle = trimFill;
            break;

        case "scythes":
            leftHelmet = rightHelmet = leftShoulder = rightShoulder = leftShoulderTrim = rightShoulderTrim = leftArm = rightArm = leftHand = rightHand = leftThigh = rightThigh = leftShin = rightShin = leftBoot = rightBoot = leftArmTrim = rightArmTrim = leftLegTrim = rightLegTrim = primaryFill;
            leftBackpack = rightBackpack = codLeft = codRight = leftChest = rightChest = secondaryFill;
            leftBelt = rightBelt = eagle = trimFill;
            break;

        case "shoulders":
            leftBackpack = rightBackpack = leftChest = rightChest = leftArm = rightArm = leftHand = rightHand = leftThigh = rightThigh = leftShin = rightShin = leftBoot = rightBoot = codLeft = codRight = leftBelt = rightBelt = leftArmTrim = rightArmTrim = leftLegTrim = rightLegTrim = primaryFill;
            leftShoulder = rightShoulder = leftShoulderTrim = rightShoulderTrim = secondaryFill;
            leftHelmet = rightHelmet = eagle = trimFill;
            break;

        case "talons":
            leftChest = rightChest = leftShoulderTrim = rightShoulderTrim = leftArm = rightArm = leftHand = rightHand = codLeft = codRight = leftBelt = rightBelt = leftArmTrim = rightArmTrim = primaryFill;
            leftHelmet = rightHelmet = leftBackpack = rightBackpack = leftShoulder = rightShoulder = leftLegTrim = leftThigh = rightThigh = leftShin = rightShin = leftBoot = rightBoot = rightLegTrim = secondaryFill;
            eagle = trimFill;
            break;


        default:
            leftHelmet = rightHelmet = leftBackpack = rightBackpack = leftChest = rightChest = leftShoulder = rightShoulder = leftShoulderTrim = rightShoulderTrim = leftArm = rightArm = leftHand = rightHand = leftThigh = rightThigh = leftShin = rightShin = leftBoot = rightBoot = codLeft = codRight = leftBelt = rightBelt = eagle = leftArmTrim = rightArmTrim = leftLegTrim = rightLegTrim = primaryFill;
    }
    ...
    return (
        <svg
            ...
            <g
                id="Right-Shoulder-Trim"
                style={{
                    fill: rightShoulderTrim
                }}
                transform="matrix(-0.583551,0.218523,3.05977,8.17092,139.543,-295.676)"
            >

                <path d="M112.54,48.232L112.923,49.197L42.781,49.4L30.23,49.388L29.857,48.299L71.668,48.215L96.316,48.151C96.316,48.151 96.399,48.152 96.554,48.153L94.62,39.099L110.008,39.117L111.106,42.933L111.911,45.575L112.575,48.232L112.54,48.232Z" />
            </g>
            <g
                id="Right-Shoulder-Pad"
                transform="matrix(-0.693583,0.263428,0.286145,0.753395,249.991,-0.511926)"
                style={{
                    fill: rightShoulder
                }}
            >
                <path d="M79.38,36.047L79.586,37.945L80.572,79.148L80.849,93.09L81.216,112.144L81.48,122.636L81.625,129.893L28.84,131.592L28.065,111.435L29.188,91.697L31.885,78.33L35.24,67.214L37.563,62.387L38.423,60.838L40.833,57.476L44.479,52.968L49.209,48.559L52.674,45.991L57.842,42.733L63.841,40L69.091,38.242L73.08,37.142L79.38,36.047Z" />
            </g>
            <g
                id="Left-Shoulder-Trim"
                transform="matrix(0.583551,0.218523,-3.05977,8.17092,158.513,-295.676)"
                style={{
                    fill: leftShoulderTrim
                }}
            >
                <path d="M112.54,48.232L112.923,49.197L42.781,49.4L30.23,49.388L29.857,48.299L71.668,48.215L96.316,48.151C96.316,48.151 96.399,48.152 96.554,48.153L94.62,39.099L110.008,39.117L111.106,42.933L111.911,45.575L112.575,48.232L112.54,48.232Z" />
            </g>
            <g
                id="Left-Shoulder-Pad"
                transform="matrix(0.693583,0.263428,-0.286145,0.753395,47.8067,-0.511926)"
                style={{
                    fill: leftShoulder
                }}
            >
                <path d="M79.809,35.88L81.917,129.764L28.575,131.241C28.298,113.628 28.513,101.353 28.977,91.771L35.24,67.214L38.623,61.113L40.89,57.615L43.682,54.174L47.871,49.848L52.674,45.991L57.842,42.733L63.841,40L69.091,38.242L73.08,37.142L79.809,35.88Z" />
            </g>
            <g
                id="Right-Hand"
                transform="matrix(-1,0,0,1,268.081,-55)"
                style={{
                    fill: rightHand

                }}>
                <path d="M15.584,248.549C7.554,236.981 -2.117,232.289 -14.674,238.09L-22.026,255.993L-23.844,260.08L-19.392,266.164L-12.924,273.597C-10.204,273.903 -8.785,271.826 -6.613,272.136L-0.267,270.733L2.841,266.995L4.81,265.328L4.985,267.838L5.453,270.659L7.319,270.659L9.326,269.489L12.794,263.598L15.584,248.549Z" />
            </g>
            <g
                id="Right-Forearm"
                transform="matrix(-1,0,0,1,268.081,-55)"
                ...
            </g>
            <g
                id="Right-Thigh"
                transform="matrix(-1,0,0,1,296.007,-8)"
                style={{
                    fill: rightThigh
                }}>
            ...
            <g
                id="Right-Boot"
                transform="matrix(-1.68657,0,0,2.6875,396.283,-312)"
                style={{
                    fill: rightBoot
                }}>
                <path d="M80.327,258.453L82.147,256.035L85.562,253.331L88.823,251.784L91.902,250.889L95.02,250.337L98.352,250.276L102.701,250.776L106.305,251.751L109.406,253.009L112.373,254.985L115.207,258.103L116.554,261.181L116.863,263.599L119.262,263.93L121.228,263.73L120.327,269.381L116.628,269.652L116.53,270.635L90.921,270.703L77.914,270.729L77.825,267.25L80.653,267.033C80.49,265.459 80.907,264.431 81.311,263.39L78.664,262.874L79.003,260.975L80.327,258.453Z" />
            </g>
            <g
                id="Left-Boot"
                transform="matrix(1.68657,0,0,2.6875,-98.4328,-312)"
                style={{
                    fill: leftBoot
                }}>
                <path d="M80.327,258.453L82.147,256.035L85.562,253.331L88.823,251.784L91.902,250.889L94.602,250.577L98.352,250.276L102.701,250.776L106.305,251.751L109.406,253.009L112.373,254.985L115.207,258.103L116.554,261.181L116.863,263.599L118.977,263.818L121.228,263.73L120.399,269.392L116.628,269.652L116.53,270.635L90.921,270.703L77.914,270.729L77.825,267.25L80.653,267.033L81.311,263.39L78.664,262.874L80.327,258.453Z" />
            </g>
            <g
                id="Right-Shin"
                transform="matrix(-1.68657,0,0,2.6875,397.017,-312)"
                style={{
                    fill: rightShin

                }}>
                <path d="M135.663,221.3L134.55,223.121L127.062,224.182L126.728,226.025L128.068,227.428L128.969,230.798L128.78,234.662L128.275,238.566L127.349,243.407L125.634,253.484L126.217,254.211L126.195,255.278L126.103,257.695L124.421,261.093L122.423,263.034L121.188,263.547L119.838,263.965L117.073,263.535L116.692,260.897L115.543,258.248L113.76,256.041L110.383,253.513L105.675,251.393L101.395,250.524L95.879,250.271L92.152,250.812L87.849,252.124L84.853,253.74L82.184,256.064L80.421,258.11L78.348,256.221L77.444,253.911L77.343,251.805L78.029,249.185L79.483,247.026L80.787,245.535L81.887,245.326L85.899,239.458L90.358,231.183L94.193,224.215L95.697,222.3L96.186,222.316L97.771,219.434L99.031,218.316L95.37,214.139L96.06,213.583L96.592,212.244L101.445,210.252L104.935,209.319L107.886,209.01L110.097,208.953L112.209,209.01L115.182,209.255L118.827,209.89L121.793,210.635L124.959,211.772L127.01,212.741L128.497,213.564L129.819,214.404L131.514,215.683L132.567,216.667L133.907,218.343L135.077,220.194L135.663,221.3Z" />
            </g>
            <g
                id="Left-Shin"
                transform="matrix(1.68657,0,0,2.6875,-98.4328,-312)"
                ...
                <path d="M135.412,221.3L134.55,223.121L127.062,224.182L126.449,225.955L127.928,227.655L128.69,230.851L128.668,234.627L127.098,243.109L125.634,253.484L126.195,255.278L125.796,257.835L124.365,260.953L122.423,263.034L121.188,263.547L119.838,263.965L117.073,263.535L115.599,258.826L113.76,256.041L110.383,253.513L105.675,251.393L101.395,250.524L95.879,250.271L92.152,250.812L87.849,252.124L84.853,253.74L82.184,256.064L79.919,258.127L78.376,256.501L77.249,254.348L77.12,251.858L77.833,249.15L79.316,246.886L80.787,245.535L81.663,245.274L85.76,239.388L90.163,231.253L94.026,224.127L95.753,222.212L97.715,219.364L98.696,218.368L95.23,214.122L96.285,212.244L101.445,210.252L104.935,209.319L107.886,209.01L110.097,208.953L112.209,209.01L115.182,209.255L118.827,209.89L121.793,210.635L124.959,211.772L127.01,212.741L128.497,213.564L129.819,214.404L131.514,215.683L132.567,216.667L133.907,218.343L135.077,220.194L135.412,221.3Z" />
            </g>
            <g
                id="Left-Thigh"
            ...
            <g id="Right-Helmet" transform="matrix(-1,0,0,1.03448,297.987,-0.37931)"
                style={{
                    fill: rightHelmet

                }}>
                <path d="M150.013,12.524L150.013,67.825L149,67.825L144.926,67.765L142.25,67.618L138.969,66.861L133.289,65.491C130.327,64.737 127.506,63.845 124.742,62.898L121.548,61.647L121.151,61.278C121.144,60.525 121.119,59.012 121.119,59.012L120.377,58.7L118.469,57.477L118.364,44.646L120.459,43.495L119.795,42.407L117.657,39.728L117.722,39.527L118.219,39.202L125.567,35.317L126.194,31.218L127.133,27.845L128.906,24.252L131.066,21.306L133.52,18.908L135.49,17.901L138.024,17.289L138.021,14.429L140.523,13.433L142.914,12.773L146.636,12.376L150.013,12.524Z" />
            </g>
            <g
                id="Left-Helmet"
                transform="matrix(-1,0,0,1.03448,297.987,-0.37931)"
                style={{
                    fill: leftHelmet

                }}>
                <path d="M148.976,67.983L153.061,67.765L155.737,67.618L159.018,66.861L164.697,65.491C167.66,64.737 170.481,63.845 173.245,62.898L176.836,61.278C176.843,60.525 176.867,59.012 176.867,59.012L177.61,58.7L179.517,57.477L179.623,44.646L177.527,43.495L178.191,42.407L180.33,39.728L179.768,39.202L172.419,35.317L171.792,31.218L170.854,27.845L169.081,24.252L166.921,21.306L164.467,18.908L162.497,17.901L159.962,17.289L159.966,14.429L157.464,13.433L155.072,12.773L151.351,12.376L148.976,12.251L148.976,67.983Z" />
            </g>
            <g id="Left-Eye" transform="matrix(1,0,0,1,28,11.0868)">
                <path d="M118,30L112.899,32.476C109.625,32.483 107.257,31.473 106.382,29.767L105,26L118,30Z" fill={lenses} />
            </g>


            <g id="Right-Eye" transform="matrix(1,0,0,1,47.1516,11.1037)">
                <path d="M118.463,26.202L116.687,30C114.785,31.836 112.862,32.527 109.419,32.137C107.561,31.666 106.173,30.9 105,30C108.892,28.095 113.373,26.822 118.463,26.202Z" fill={lenses} />
            </g>

            <g
                id="Cod-Right"
                transform="matrix(-1,0,0,1,297.148,0)"
                style={{
                    fill: codRight
                }}>
                <path d="M149.174,200.236L149.174,240.115C147.703,239.684 145.317,239.539 143.989,238.964C142.814,238.455 141.664,237.498 140.48,236.662L138.737,234.967L135.704,230.258L133.568,225.571L131.708,220.261L129.417,213.223L127.895,208.152L125.693,200.96L125.172,198.387L125.429,196.066L126.213,194.529L127.001,194.399L127.611,194.616L130.03,196.273L133.582,198.092L138.049,199.212L142.962,199.889L149.174,200.236Z" />
                <path d="M84.109,45.989L91.009,44.843C77.676,43.488 60.269,43.021 38.696,43.463L32.258,44.532L34.142,44.765C59.938,44.245 69.135,44.621 84.109,45.989Z" />
            </g>

            <g id="Right-Arm-Trim" transform="matrix(-0.623124,2.79438e-06,3.91272e-05,8.72503,304.741,-207.686)"
                style={{
                    fill: rightArmTrim
                }}>
                <path d="M84.109,45.989L91.009,44.843C77.676,43.488 60.269,43.021 38.696,43.463L32.258,44.532L34.142,44.765C59.938,44.245 69.135,44.621 84.109,45.989Z" />
            ...
            <g id="Artboard1" transform="matrix(0.0996347,0,0,0.134018,53.1053,6.29886)">
                ...
                <g transform="matrix(1.41828,0,0,1.0544,-533,-47)">
                    ...
                    <g transform="matrix(1,0,0,1,1032,325)">
                        <path d="M0,0L6,0L10,3L11,10L4,18L-10,30L-23,41L-27,43L-34,42L-37,38L-37,32L-30,24L-19,15L-4,2L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1071,325)">
                        <path d="M0,0L6,0L12,4L40,28L43,32L43,38L40,42L33,43L24,37L12,26L1,17L-5,10L-4,3L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    ...
                    <g transform="matrix(1,0,0,1,1023,709)">
                        <path d="M0,0L15,0L23,5L25,9L25,16L18,24L8,29L0,31L-12,31L-17,26L-18,22L-18,15L-15,9L-8,3L0,0ZM1,3L-9,7L-14,13L-15,22L-13,27L-11,28L0,28L12,24L18,20L22,15L21,8L17,4L14,3L1,3Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1071,709)">
                        <path d="M0,0L15,0L25,4L32,12L33,15L33,22L30,29L27,31L15,31L2,27L-6,21L-10,16L-10,9L-6,3L0,0ZM1,3L-4,6L-7,10L-6,17L1,23L11,27L15,28L26,28L29,25L30,16L27,10L22,6L14,3L1,3Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1053,728)">
                        <path d="M0,0L4,1L9,9L13,21L14,30L13,33L8,34L3,31L-1,32L-5,34L-10,33L-11,26L-7,11L-2,2L0,0ZM0,4L-4,12L-8,26L-7,31L0,27L4,28L10,31L11,26L7,12L4,6L0,4Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,316,876)">
                        <path d="M0,0L16,0L36,4L69,15L89,24L114,36L137,49L158,63L171,73L181,82L189,90L191,95L188,96L182,88L173,79L160,69L139,55L113,40L87,27L63,17L36,8L23,5L-1,3L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1777,876)">
                        <path d="M0,0L16,0L17,3L-7,5L-30,11L-55,20L-81,32L-101,42L-128,58L-148,72L-161,83L-169,91L-172,96L-175,95L-173,90L-158,75L-145,65L-127,53L-112,44L-90,32L-65,20L-39,10L-20,4L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,686,899)">
                        <path d="M0,0L9,0L15,4L18,9L18,18L13,30L8,40L-3,72L-9,79L-13,81L-20,81L-26,77L-30,71L-30,62L-20,32L-9,8L-4,2L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1414,899)">
                        <path d="M0,0L9,0L15,4L21,14L30,35L39,62L39,71L35,77L29,81L22,81L16,77L12,72L1,40L-8,21L-9,18L-9,9L-5,3L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,297,912)">
                        <path d="M0,0L15,1L48,6L72,12L93,20L112,30L124,38L143,52L171,76L184,88L184,91L180,89L168,78L160,71L147,60L130,47L114,36L98,27L83,20L65,14L36,8L0,3L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1805,912)">
                        <path d="M0,0L7,0L7,3L-35,9L-58,14L-76,20L-99,31L-116,42L-132,54L-143,63L-156,74L-168,85L-175,91L-178,90L-172,83L-160,72L-149,63L-135,51L-117,38L-98,26L-79,17L-58,10L-36,5L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,730,922)">
                        <path d="M0,0L10,0L17,6L19,11L18,20L9,39L3,52L-5,81L-9,87L-15,91L-23,91L-29,87L-32,83L-33,73L-26,49L-22,36L-7,6L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1369,922)">
                        <path d="M0,0L10,0L18,7L29,31L34,41L43,73L42,83L37,89L33,91L25,91L19,87L15,81L7,52L1,39L-9,17L-8,8L-2,1L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,279,940)">
                        <path d="M0,0L8,1L46,11L79,22L99,31L117,42L128,50L141,60L154,71L165,80L180,93L182,95L182,98L178,96L163,83L149,71L135,60L119,48L103,38L86,29L62,20L27,10L0,3L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1826,940)">
                        <path d="M0,0L4,0L4,3L-38,14L-67,23L-88,32L-106,42L-123,54L-137,65L-148,74L-176,98L-178,98L-177,94L-165,83L-154,74L-140,62L-123,49L-105,37L-89,28L-64,18L-35,9L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,777,954)">
                        <path d="M0,0L7,1L13,5L16,12L15,20L1,48L-12,83L-17,91L-22,95L-29,96L-36,93L-40,88L-41,86L-41,78L-25,36L-16,17L-8,4L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1328,954)">
                        <path d="M0,0L7,1L13,5L20,17L29,36L42,70L45,78L45,86L41,92L37,95L29,96L23,93L18,87L10,67L2,46L-11,20L-12,12L-8,4L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,801,1430)">
                        <path d="M0,0L5,2L19,10L36,21L50,31L61,40L76,54L92,70L91,73L84,67L69,52L61,45L48,34L31,22L11,10L0,3L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1306,1430)">
                        <path d="M0,0L3,1L-1,5L-24,19L-39,29L-52,39L-64,50L-74,59L-88,73L-90,72L-88,68L-65,45L-57,38L-39,24L-15,9L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,816,1499)">
                        <path d="M0,0L4,2L17,11L33,23L43,31L57,43L73,59L80,67L93,81L100,89L108,98L107,102L101,97L94,89L67,59L49,41L38,32L20,18L3,6L-1,3L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1291,1499)">
                        <path d="M0,0L3,1L2,4L-12,14L-31,28L-44,39L-54,48L-72,66L-79,74L-90,86L-104,102L-106,101L-105,97L-92,83L-85,75L-63,51L-52,40L-41,31L-29,21L-15,11L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,656,1574)">
                        <path d="M0,0L9,2L42,19L58,28L67,35L70,40L70,48L64,55L55,56L47,52L37,46L14,34L-6,23L-10,18L-11,16L-10,7L-5,2L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1450,1574)">
                        <path d="M0,0L7,1L12,6L14,10L14,16L10,22L0,28L-29,43L-43,51L-49,55L-58,56L-63,53L-67,48L-67,40L-64,35L-55,28L-37,18L-15,7L-4,1L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,636,1611)">
                        <path d="M0,0L7,0L53,23L69,33L74,39L75,41L74,50L69,55L64,57L55,55L44,48L15,33L0,25L-5,22L-9,16L-9,9L-6,4L-3,1L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                    <g transform="matrix(1,0,0,1,1466,1611)">
                        <path d="M0,0L7,0L12,3L15,6L16,9L16,16L12,22L7,25L-16,37L-41,50L-50,56L-57,57L-64,54L-68,47L-68,41L-64,35L-53,27L-24,12L-3,1L0,0Z" style={{ fillRule: "nonzero" }} />
                    </g>
                </g>
            </g>
